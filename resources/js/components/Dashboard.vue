...
const getAppointmentsCount = () => {
    axios.get('/api/stats/appointments',{
        ...
        .then(resp=>{
            totalAppointmentsCount.value=resp.data.totalAppointmentCount;
        })
};
const getUsersCount=()=>{
    axios.get('/api/stats/users',{
        ...
        .then(resp=>{
            totalUsersCount.value=resp.data.totalUsersCount;
        })
            ...
            <div class="row">
                <div class="col-lg-3 col-6">
                    <div class="small-box bg-info">
                        ...
                        <router-link :to="{name:'admin.appointments'}" class="small-box-footer">
                            View Appointments
                ...
                <div class="col-lg-3 col-6">
                    <div class="small-box bg-info">
                        ...
                        <router-link :to="{name:'admin.users'}" class="small-box-footer">
                            View Users
                            <i class="fas fa-arrow-circle-right"></i>
                        </router-link>
                    </div>
